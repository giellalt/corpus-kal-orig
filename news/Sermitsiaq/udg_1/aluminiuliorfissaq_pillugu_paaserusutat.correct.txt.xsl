...
<xsl:variable name="title" select="'Aluminiuliorfissaq pillugu paaserusutat'"/>
<xsl:variable name="author1_fn" select="'Mads'"/>
<xsl:variable name="author1_ln" select="'DollerupScheibel'"/>
...
<xsl:variable name="translator_fn" select="'M'"/>
<xsl:variable name="translator_ln" select="'Berthelsen'"/>
