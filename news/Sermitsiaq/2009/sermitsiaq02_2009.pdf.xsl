...
<!-- variable filename contains the original name of the file (from submitter)-->
  <xsl:variable name="filename" select="'sermitsiaq02_2009.pdf'"/>
  <xsl:variable name="title" select="'Sermitsiaq02_2009'"/>
  ...
  <xsl:variable name="translated_from" select="'oth'"/>
  <xsl:variable name="publisher" select="'Sermitsiaq'"/>
  ...
  <xsl:variable name="sub_name" select="'Per Langgård'"/>
  <xsl:variable name="sub_email" select="'pela@gh.gl'"/>
...
<!-- checked for all the languages below. -->
  ...
  <xsl:variable name="mlang_oth" select="'1'"/>
