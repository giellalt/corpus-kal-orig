...
<xsl:variable name="title" select="'Ujaraannarnik sakkoqarallarnerup nalaaneersut Peary Landimi silarsuat'"/>
<xsl:variable name="author1_fn" select="'Jens'"/>
<xsl:variable name="author1_ln" select="'Fog Jensen'"/>
<xsl:variable name="author1_gender" select="'m'"/>
<xsl:variable name="author1_nat" select="''"/>
<xsl:variable name="author1_born" select="''"/>
<xsl:variable name="author2_fn" select="'Claus'"/>
<xsl:variable name="author2_ln" select="'Andreasen'"/>
...
<xsl:variable name="publisher" select="'AG'"/>
<xsl:variable name="publChannel" select="''"/>
<xsl:variable name="year" select="'2008'"/>
<xsl:variable name="ISBN" select="''"/>
<xsl:variable name="ISSN" select="''"/>
<xsl:variable name="place" select="'Nuuk'"/>
...
<xsl:variable name="sub_name" select="'Elin Neshamar'"/>
<xsl:variable name="sub_email" select="'elne@nanoq.gl'"/>
