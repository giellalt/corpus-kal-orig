...
<xsl:variable name="title" select="'Oqaatsitta salliutinneqarnissaat uumissuinermik tunngaveqanngilluinnarpoq'"/>
<xsl:variable name="author1_fn" select="'Edvard'"/>
<xsl:variable name="author1_ln" select="'Geisler'"/>
