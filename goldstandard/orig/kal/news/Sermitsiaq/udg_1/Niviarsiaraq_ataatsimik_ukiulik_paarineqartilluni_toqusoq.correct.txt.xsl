...
<xsl:variable name="title" select="'Niviarsiaraq ataatsimik ukiulik paarineqartilluni toqusoq'"/>
<xsl:variable name="author1_fn" select="'Dorthe'"/>
<xsl:variable name="author1_ln" select="'Heilmann'"/>
...
<xsl:variable name="translator_fn" select="'Nuka'"/>
<xsl:variable name="translator_ln" select="'Jørgensen'"/>
