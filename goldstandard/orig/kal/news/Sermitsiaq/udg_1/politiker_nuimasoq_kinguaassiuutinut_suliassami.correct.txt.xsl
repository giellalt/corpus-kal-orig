...
<xsl:variable name="title" select="'Politiker nuimasoq kinguaassiuutinut suliassami'"/>
<xsl:variable name="author1_fn" select="'Irene'"/>
<xsl:variable name="author1_ln" select="'Jepson'"/>
