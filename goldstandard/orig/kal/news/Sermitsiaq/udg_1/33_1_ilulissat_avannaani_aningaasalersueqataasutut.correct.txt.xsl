...
<xsl:variable name="title" select="'Ilulissat avannaani aningaasalersueqataasutut'"/>
<xsl:variable name="author1_fn" select="'Bendt'"/>
<xsl:variable name="author1_ln" select="'Kristiansen'"/>
