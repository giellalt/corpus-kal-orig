...
<xsl:variable name="title" select="'Inunnik isiginnittarneq eqqartuussinerusoq immikkoortitsinerusorlu'"/>
<xsl:variable name="author1_fn" select="'Maja'"/>
<xsl:variable name="author1_ln" select="'Chemnitz Frederiksen'"/>
