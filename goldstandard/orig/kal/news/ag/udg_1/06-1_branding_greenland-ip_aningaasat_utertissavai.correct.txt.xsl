...
<xsl:variable name="title" select="'Branding Greenland-ip aningaasat utertissavai'"/>
<xsl:variable name="author1_fn" select="'Nicolai'"/>
<xsl:variable name="author1_ln" select="'Stampe Qvistgaard'"/>
...
<xsl:variable name="translator_fn" select="'Utertoq'"/>
<xsl:variable name="translator_ln" select="'Nielsen'"/>
