...
<xsl:variable name="title" select="'Angajoqqaarsiaasartunut malittarisassat allanngortinneqassanngillat'"/>
<xsl:variable name="author1_fn" select="'L'"/>
<xsl:variable name="author1_ln" select="'P'"/>
