...
<xsl:variable name="title" select="'Petrus Brønlund arsaararnermi pissartanngorniuteqataanissaminut piareerpoq'"/>
<xsl:variable name="author1_fn" select="'J'"/>
<xsl:variable name="author1_ln" select="'J'"/>
