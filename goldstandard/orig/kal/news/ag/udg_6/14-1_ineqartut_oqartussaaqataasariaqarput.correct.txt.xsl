...
<xsl:variable name="title" select="'Ineqartut oqartussaaqataasariaqarput'"/>
<xsl:variable name="author1_fn" select="'Ludvig'"/>
<xsl:variable name="author1_ln" select="'Siegstad'"/>
