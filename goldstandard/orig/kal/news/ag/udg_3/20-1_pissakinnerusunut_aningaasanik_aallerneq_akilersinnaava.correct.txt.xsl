...
<xsl:variable name="title" select="'Pissakinnerusunut aningaasanik aallerneq akilersinnaava?'"/>
<xsl:variable name="author1_fn" select="'Ane'"/>
<xsl:variable name="author1_ln" select="'Egede Mathæussen'"/>
