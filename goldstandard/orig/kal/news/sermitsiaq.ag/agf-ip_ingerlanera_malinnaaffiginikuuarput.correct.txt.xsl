...
<xsl:variable name="filename" select="'http://sermitsiaq.ag/kl/node/148871'"/>
<xsl:variable name="text_encoding" select="''"/>
<xsl:variable name="title" select="'Ane Hansen: AGF-ip ingerlanera malinnaaffiginikuuarput'"/>
<xsl:variable name="author1_fn" select="'Nukappiaaluk'"/>
