...
<xsl:variable name="title" select="'Kinaassuseq inuiaassuserlu'"/>
<xsl:variable name="author1_fn" select="'Nivikkannguaq'"/>
<xsl:variable name="author1_ln" select="'Mørch Reimer'"/>
