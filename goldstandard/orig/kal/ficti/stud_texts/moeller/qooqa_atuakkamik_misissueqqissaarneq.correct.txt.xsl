...
<xsl:variable name="title" select="'Qooqa/Atuakkamik misissueqqissaarneq'"/>
<xsl:variable name="author1_fn" select="'Tuperna'"/>
<xsl:variable name="author1_ln" select="'Møller'"/>
...
<xsl:variable name="place" select="'Sisimiut'"/>
