...
<xsl:variable name="title" select="'Isummiutiinnartakkat qimarratingalugit'"/>
<xsl:variable name="author1_fn" select="'Kunuuti'"/>
<xsl:variable name="author1_ln" select="'Kleemann'"/>
